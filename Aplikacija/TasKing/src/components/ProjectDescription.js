...
export default function ProjectDescription() {
  return (
    <div className='descriptionDiv'>
        <h1>Projekat iz SWE</h1>
        <h3>Ovo je projekat iz softverskog inzinjerstva. Cilj ovog projekta je da se napravi aplikacije Tasking koja ce da omoguci laski i pravedniji rad u timovima.
